    ...
    return (
        <div className='container about-page'>
            <div className='text-zone'>
                <h1>About Me</h1>
                <p>Interested in the BackEnd area with the ability to make web projects, always opting for them to have high scalability and modularizing to make it an easier task to work with my team.
